...
local user_symbol="⭐ 𝔗𝔥𝔞𝔫𝔢"
if [[ $(print -P "%#") =~ "#" ]]; then
    user_symbol = "#"
fi
POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX="%{%B%F{yellow}%K{red}%} $user_symbol%{%b%f%k%F{red}%} %{%f%}"
...
# Example format: plugins=(git rsync zsh-autosuggestions zsh-syntax-highlighting)
...
[[ -f ~/.dotfiles/.zshrc ]] && source ~/.dotfiles/.zshrc
export NVM_DIR=~/.nvm
export PATH="$PATH:/Users/thane/Development/flutter/bin"
